                ...
                <div className='border-2 px-10 rounded-2xl py-10'>
                    ...
                    <div className='newac1 grid grid-cols-1 cols-span-2'>
                        <div className='feild1 py-3'>
                            ...
                            <textarea type="text" placeholder='Please enter project name here' className="w-[100%] mt-2  rounded-3xl bg-[#DBDBDB] h-[105px] form-control w-[100%] border-t-0 border-l-0 border-r-0 border-b-0"></textarea>
                        </div>
                    </div>
                    <div className='cadd flex rounded-3xl h-[36px] bg-[#DBDBDB] w-[100%] justify-center mt-5'>
...
export default MainGroupProject