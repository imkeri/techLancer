        ...
        <div>
            <div className='max-w-7xl mx-auto justify-between items-center px-4 py-5 sm:px-6 sm:py-4 lg:px-0 lg:justify-start lg:space-x-10 mt-[20px]'>
                <div className=" py-5 px-4  sm:px-6 lg:px-8 ">
                    ...
                    <div className="mt-6 grid grid-cols-6 py-3 gap-5 justify-center imgs bg-[#fff] rounded">
                        <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1 sm:col-span-2">
                            <img
                                className="h-[96px] self-center w-[96px]"
                                src="../img/par1.png"
                                alt="Tuple"
                            />
                        </div>
                        <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1 sm:col-span-2">
                            <img
                                className="h-[95px] self-center w-[99px]"
                                src="../img/chai.png"
                                alt="StaticKit"
                            />
                        </div>
                        <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1 sm:col-span-2">
                            <img
                                className="h-[50px] self-center w-[215px]"
                                src="../img/skill.png"
                                alt="Mirage"
                            />
                        </div>
                        <div className="col-span-1 flex justify-center md:col-span-2  lg:col-span-1 sm:col-span-2">
                            <img
                                className="h-[90px] self-center w-[173px]"
                                src="../img/logic.png"
                                alt="Transistor"
                            />
                        </div>
