        ...
        <div>
            <div className='max-w-2xl mx-auto justify-between items-center px-0 py-5 sm:px-6 sm:py-4 lg:px-8 lg:justify-start lg:space-x-10 my-[90px]'>
                <div className='border-2 px-10 rounded-2xl'>
                    ...
                    <div className='py-2 ml-3'>
                        ...
                        <div className='lookfor flex gap-10'>
                            <div className='flex gap-3'>
                                <input type="checkbox" className='w-[25px] h-[25px] bg-[#D9D9D9] rounded border-t-0 border-l-0 border-b-0 border-r-0'></input>
                    ...
                    <div className='interest flex flex-col py-5'>
                        <p className='text-[18px] font-semibold ml-3 pb-0'>Preferrred locations</p>
                        <p className='text-[#A5A5A5] text-[15px] font-medium ml-3'>Leave this blank if you do not have any preference</p>
                        <select className='rounded-3xl bg-[#DBDBDB] form-control w-[100%] h-[36px] my-2 border-t-0 border-l-0 border-r-0 border-b-0 text-[#A5A5A5]'>
                            <option value="1">Select your 1st preference</option>
                            <option value="2">abcd</option>
                            <option value="3">abcd</option>
                            <option value="4">abcd</option>
